!(function (t) {
  ...
  o.loadJson = function (t) {
    ...
    if (i.setFadeIn(Number.parseInt(r.fade_in) > 0 ? Number.parseInt(r.fade_in) : 1e3),
    i.setFadeOut(Number.parseInt(r.fade_out) > 0 ? Number.parseInt(r.fade_out) : 1e3),
    r.params == null) {
      return i
    }
    let s = r.params
  ...
  l.load = function (t) {
    for (var i = new l(), e = c.getPlatformManager(), r = e.jsonParseFromBytes(t), o = r.physics_hair, n = o.length, s = 0; s < n; s++) {
      ...
      let h = _.setup
      let $ = Number.parseFloat(h.length)
      let u = Number.parseFloat(h.regist)
      let p = Number.parseFloat(h.mass)
      a.setup($, u, p)
      for (var f = _.src, d = f.length, g = 0; g < d; g++) {
        ...
        var S = Number.parseFloat(y.scale)
        var v = Number.parseFloat(y.weight)
      ...
      for (var L = _.targets, M = L.length, g = 0; g < M; g++) {
        ...
        var S = Number.parseFloat(E.scale)
        var v = Number.parseFloat(E.weight)
  ...
  l.prototype.updateParam = function (t) {
    for (let i = UtSystem.getUserTimeMSec() - this.startTimeMSec, e = 0; e < this.physicsList.length; e++)
  ...
  $.prototype.updateParam = function (t) {
    if (t != null) {
      ...
      this.lastTime = i,
      e < 0 && (e = 0)
      for (let r = 0; r < this.partsGroups.length; r++) {
      ...
      for (let i = 0; i < this.partsGroups.length; i++) {
        for (let e = this.partsGroups[i], r = 0; r < e.length; r++) {
          ...
          if (!(o < 0)) {
            ...
            e[r].link != null) {
              for (let _ = 0; _ < e[r].link.length; _++)
  ...
  function n(t) {
    ...
    let r = e / i
    let o = w.default.VIEW_LOGICAL_LEFT
    let n = w.default.VIEW_LOGICAL_RIGHT
    let _ = -r
    let h = r
  ...
  function g(t) {
    if (t.type == 'mousewheel') {
    ...
    else if (t.type == 'mousedown') {
      p(t)
    }
    else if (t.type == 'mousemove') {
      let i = sessionStorage.getItem('Sleepy')
      i === '1' && sessionStorage.setItem('Sleepy', '0'),
      u(t)
    }
      ...
      c()
      let e = sessionStorage.getItem('SleepyTimer')
  ...
  var O = r(x)
  var D = e(2)
  var R = (window.navigator.platform.toLowerCase(),
  new A.default())
  var b = !1
  var F = null
  var C = null
    ...
    !(function () {
      ...
      function e(t) {
        if (!At) {
          ...
          i.a = 0,
          this.CHANNEL_COLORS.push(i)
          for (let e = 0; e < this.CHANNEL_COLORS.length; e++)
      ...
      function Tt(t, i, e) {
        return i == null && (i = t.createBuffer()),
      ...
      i.prototype.getModelImpl = function () {
        return this._$MT == null && (this._$MT = new p(),
        this._$MT._$zP()),
        this._$MT
      },
      ...
      i.prototype.getParamFloat = function (t) {
        return typeof t != 'number' && (t = this._$5S.getParamIndex(u.getID(t))),
      ...
      i.prototype.setPartsOpacity = function (t, i) {
        typeof t != 'number' && (t = this._$5S.getPartsDataIndex(l.getID(t))),
      ...
      i.prototype.getPartsOpacity = function (t) {
        return typeof t != 'number' && (t = this._$5S.getPartsDataIndex(l.getID(t))),
      ...
      e.prototype.releaseShader = function () {
        for (let t = at.frameBuffers.length, i = 0; i < t; i++)
      ...
      s.prototype.updateParam = function (t, i) {
        if (i._$AT && !i._$9L) {
          ...
          let o = this._$V0
          o = o * (this._$dP == 0 ? 1 : ht._$r2((e - i._$bs) / this._$dP)) * (this._$eo == 0 || i._$Do < 0 ? 1 : ht._$r2((i._$Do - e) / this._$eo)),
      ...
      f.prototype.setup = function (t, i, e) {
        this._$ks = this._$Yb(),
        this.p2._$xT(),
        arguments.length == 3 && (this._$Fo = t,
        this._$L2 = i,
        this.p1._$p = e,
        this.p2._$p = e,
        this.p2.y = t,
      ...
      F.prototype.transform = function (t, i, e) {
        let r; let o; let n; let s; let _; let a; let h = 0
        let l = 0
        switch (this._$hi) {
          default:
            return
          ...
          if (n != '\n' && n != '\r') {
            if (n != '#') {
              if (n != '$') {
                    ...
                    O.startsWith(t, s, C._$cs)
                      ...
                      : O.startsWith(t, s, C._$ar)
                        ? (a._$4P = new String(t, s + 7, _ - s - 7),
                          O.startsWith(t, s + 7, 'ANCHOR_X') ? a._$RP = B._$xs : O.startsWith(t, s + 7, 'ANCHOR_Y') ? a._$RP = B._$us : O.startsWith(t, s + 7, 'SCALE_X') ? a._$RP = B._$qs : O.startsWith(t, s + 7, 'SCALE_Y') ? a._$RP = B._$Ys : O.startsWith(t, s + 7, 'X') ? a._$RP = B._$ws : O.startsWith(t, s + 7, 'Y') && (a._$RP = B._$Ns))
                        : (a._$RP = B._$Fr,
                          a._$4P = new String(t, s, _ - s)),
                    i.motions.push(a)
                    let h = 0
                    for (C._$D2.clear(),
                    o = _ + 1; o < r && ((n = 255 & t[o]) != '\r' && n != '\n'); ++o) {
                      if (n != ',' && n != ' ' && n != '\t') {
                ...
                let u = !1
                if (_ >= 0) {
                  for (_ == s + 4 && t[s + 1] == 'f' && t[s + 2] == 'p' && t[s + 3] == 's' && (u = !0),
                  o = _ + 1; o < r && ((n = 255 & t[o]) != '\r' && n != '\n'); ++o) {
                    if (n != ',' && n != ' ' && n != '\t') {
                      var l = O._$LS(t, r, o, e)
      ...
      C.prototype.dump = function () {
        for (let t = 0; t < this.motions.length; t++) {
          ...
          for (let e = 0; e < i._$I0.length && e < 10; e++)
        ...
        for (let d = o.length, g = yt._$2o(); ;) {
          for (var y = !1, s = 0; s < d; ++s) {
            ...
            if (m != null) {
              ...
              (T == null || T == g || this.getBaseDataIndex(T) >= 0) && (this._$3S.push(m),
              this._$db.push(n[s]),
              o[s] = null,
              y = !0)
            }
      ...
      Y.prototype.update = function () {
        ...
        let n = W._$Pr()
        let s = n - o + 1;
        (this._$Ws == null || this._$Ws.length < s) && (this._$Ws = new Int16Array(s),
        ...
        for (var u = null, p = 0; p < r; ++p) {
          ...
          try {
            ...
            f._$2b(this, c)
            var d; let g = Math.floor(f._$zS(this, c) - o)
            try {
              d = this._$Vs[g]
            }
            catch (t) {
      ...
      Y.prototype.getParamIndex = function (t) {
        for (let i = this._$pb.length - 1; i >= 0; --i) {
          if (this._$pb[i] == t)
            return i
        }
      ...
      Y.prototype.getPartsDataIndex = function (t) {
        for (let i = this._$F2.length - 1; i >= 0; --i) {
          if (this._$F2[i] != null && this._$F2[i]._$p2() == t)
            return i
        }
        return -1
      },
      ...
      k._$C = function (t) {
        ...
        let e = null
        try {
          i = Array.isArray(t) ? t : new _$Xs(t, 8192),
          e = new _$js()
      ...
      X.prototype._$K2 = function () {
        for (let t = 0; t < this._$sb.length; t++) {
          this._$sb[t] != 0 && (this.gl._$Sr(1, this._$sb, t),
          this._$sb[t] = 0)
        }
      },
      ...
      z.prototype._$Nr = function (t, i) {
        ...
        if (this._$GS._$Ur(t)) {
          ...
          o <= 0) {
            ...
            let V = b._$fL + (F._$fL - b._$fL) * h
            let X = C._$fL + (N._$fL - C._$fL) * h
            let H = B._$fL + (U._$fL - B._$fL) * h
            let W = G._$fL + (Y._$fL - G._$fL) * h
            ...
            for (var j = 0 | 2 ** o, q = new Float32Array(j), J = 0; J < j; J++) {
      ...
      z.prototype._$nb = function (t, i, e, r, o, n, s) {
        this != i._$GT() && console.log('### assert!! ### ')
        for (var _, a, h = i, l = h._$Wr != null ? h._$Wr : h._$Yr, $ = Math.sin(Lt._$bS * l._$qT), u = Math.cos(Lt._$bS * l._$qT), p = h.getTotalScale(), f = l.reflectX ? -1 : 1, c = l.reflectY ? -1 : 1, d = u * p * f, g = -$ * p * c, y = $ * p * f, m = u * p * c, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s) {
          _ = e[v],
          a = e[v + 1],
          r[v] = d * _ + g * a + T,
          r[v + 1] = y * _ + m * a + P
          ...
          if (n != '\n' && n != '\r') {
            if (n != '#') {
              if (n != '$') {
                    ...
                    O.startsWith(t, _, J._$cs)
                      ...
                      : O.startsWith(t, _, J._$ar)
                        ? (h._$4P = O.createString(t, _ + 7, a - _ - 7),
                          O.startsWith(t, _ + 7, 'ANCHOR_X') ? h._$RP = B._$xs : O.startsWith(t, _ + 7, 'ANCHOR_Y') ? h._$RP = B._$us : O.startsWith(t, _ + 7, 'SCALE_X') ? h._$RP = B._$qs : O.startsWith(t, _ + 7, 'SCALE_Y') ? h._$RP = B._$Ys : O.startsWith(t, _ + 7, 'X') ? h._$RP = B._$ws : O.startsWith(t, _ + 7, 'Y') && (h._$RP = B._$Ns))
                        : (h._$RP = B._$Fr,
                          h._$4P = O.createString(t, _, a - _)),
                    i.motions.push(h)
                    let l = 0
                ...
                let f = !1
                if (a >= 0) {
                  for (a == _ + 4 && Q(t, _ + 1) == 'f' && Q(t, _ + 2) == 'p' && Q(t, _ + 3) == 's' && (f = !0),
                  o = a + 1; o < r && ((n = Q(t, o)) != '\r' && n != '\n'); ++o) {
                    if (n != ',' && n != ' ' && n != '\t') {
                      var u = O._$LS(t, r, o, e)
      ...
      Z.prototype.init = function (t) {
        ...
        return i._$Cr != null && (i._$Cr = null),
      ...
      Z.prototype.transformPoints_sdk1 = function (t, i, e, r, o, n, s) {
        for (var _, a, h, l, $, u, p, f = i, c = this._$o, d = this._$A, g = o * s, y = f._$hr != null ? f._$hr : f._$Cr, m = n; m < g; m += s) {
          at._$ts
            ? (_ = e[m],
              a = e[m + 1],
              _ < 0 ? _ = 0 : _ > 1 && (_ = 1),
      ...
      nt.expandClip = function (t, i, e, r, o, n, s, _, a, h) {
        ...
        let C = h + f * v / L
        let N = nt._$50
        return i._$P2(N) != null && (nt.clipWithTransform(t, N, M, E, A, I, w, x, O, D, F, C, R, b),
        !0)
      },
        ...
        t.getFormatVersion() >= G._$s7) {
          ...
          this._$JP != 0) {
            if ((1 & this._$JP) != 0) {
              ...
              this._$5P._$Hb = Number.parseInt(r)
            }
            (this._$JP & $t._$Os) != 0 ? this._$6s = (this._$JP & $t._$Os) >> 1 : this._$6s = $t._$ms,
      ...
      $t.prototype.init = function (t) {
        ...
        let r = this._$32()
        switch (i._$Cr != null && (i._$Cr = null),
      ...
      $t.prototype.dump = function () {
        ...
        for (var t = 0; t < this._$Eo.length; t++) {
          console.log('\n    _$30[%d] = ', t)
          for (let i = this._$Eo[t], e = 0; e < i.length; e++)
      ...
      ct.prototype.startMotion = function (t, i) {
        for (var e = null, r = this.motions.length, o = 0; o < r; ++o) {
          (e = this.motions[o]) != null && (e._$qS(e._$w0.getFadeOut()),
            ...
            if (r != null) {
              ...
              o != null
                ? (o.updateParam(t, r),
                  ...
                  e--))
                : (this.motions = this.motions.splice(e, 1),
                  e--)
            }
            else {
              this.motions.splice(e, 1),
      ...
      ct.prototype.isFinished = function (t) {
        if (arguments.length >= 1) {
          for (var i = 0; i < this.motions.length; i++) {
            ...
            if (e != null && (e._$sr == t && !e.isFinished()))
              return !1
          }
          return !0
        }
      ...
      yt._$tP = new Object(),
      yt._$2o = function () {
        return yt._$eT == null && (yt._$eT = yt.getID('DST_BASE')),
        yt._$eT
      },
      yt._$27 = function () {
        yt._$tP.clear(),
      ...
      mt.prototype._$K2 = function () {
        for (let t = 0; t < this.textures.length; t++) {
          this.textures[t] != 0 && (this.gl._$K2(1, this.textures, t),
      ...
      St.prototype._$8L = function () {
        return this._$hL == 0
          ? this._$v0 = this._$ST()
          : this._$hL == 8 && (this._$v0 = this._$ST(),
          this._$hL = 0),
  ...
  r.prototype.loadTexture = function (t, i, e, r) {
    ...
    n.onload = function () {
      ...
      t.isPremultipliedAlpha() == 0 && e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1),
  ...
  r.prototype.jsonParseFromBytes = function (t) {
    ...
    return i = e[0] == 239 && e[1] == 187 && e[2] == 191 ? String.fromCharCode.apply(null, new Uint8Array(t, 3)) : String.fromCharCode.apply(null, new Uint8Array(t)),
    JSON.parse(i)
  },
        ...
        for (let i = 0; i < r.modelSetting.getTextureNum(); i++) {
          ...
          r.loadTexture(i, o, () => {
            if (r.isTexLoaded) {
              ...
              if (r.eyeBlink,
              r.modelSetting.getPhysicsFile() != null ? r.loadPhysics(r.modelHomeDir + r.modelSetting.getPhysicsFile()) : r.physics = null,
              ...
              if (r.modelSetting.getHitAreasCustom() != null) {
                ...
                s.head_x != null && (h.default.hit_areas_custom_head_x = s.head_x),
                s.head_y != null && (h.default.hit_areas_custom_head_y = s.head_y),
                s.body_x != null && (h.default.hit_areas_custom_body_x = s.body_x),
                s.body_y != null && (h.default.hit_areas_custom_body_y = s.body_y)
              }
  ...
  o.prototype.update = function () {
    ...
    this.mainMotionManager.updateParam(this.live2DModel) || this.eyeBlink != null && this.eyeBlink.updateParam(this.live2DModel),
    this.live2DModel.saveParam(),
    this.expressionManager == null || this.expressions == null || this.expressionManager.isFinished() || this.expressionManager.updateParam(this.live2DModel),
    ...
    this.lipSync == null && this.live2DModel.setParamFloat('PARAM_MOUTH_OPEN_Y', this.lipSyncValue),
  ...
  o.prototype.startMotion = function (t, i, e) {
    ...
    let o; let n = this
    this.motions[t] == null
      ? this.loadMotion(null, this.modelHomeDir + r, (r) => {
          o = r,
  ...
  r.prototype.getInitParamValue = function (t) {
    return this.json[this.INIT_PARAM] == null || this.json[this.INIT_PARAM][t] == null ? Number.NaN : this.json[this.INIT_PARAM][t][this.VALUE]
  },
  ...
  r.prototype.getInitPartsVisibleValue = function (t) {
    return this.json[this.INIT_PARTS_VISIBLE] == null || this.json[this.INIT_PARTS_VISIBLE][t] == null ? Number.NaN : this.json[this.INIT_PARTS_VISIBLE][t][this.VALUE]
  }
}]))
